...
use primitives::{amount, error, ids, Amount, Nonce};
...
mod tests {
    ...
    fn debit_rejects_insufficient_balance() {
        ...
        assert_eq!(err, StateError::Primitive(primitives::error::PrimitiveError::AmountUnderflow));
    }
    ...
    fn credit_rejects_overflow() {
        ...
        assert_eq!(err, StateError::Primitive(primitives::error::PrimitiveError::AmountOverflow));
    }
